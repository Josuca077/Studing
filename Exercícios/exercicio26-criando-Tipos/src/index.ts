...
function registerPlanet (name: string, coordinates: [number, number, number, number], situation: status) {
...
function updateSituation(name: string, situation: status) {
